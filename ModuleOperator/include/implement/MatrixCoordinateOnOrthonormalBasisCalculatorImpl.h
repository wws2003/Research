/*
 * MatrixCoordinateOnOrthonormalBasisCalculatorImpl.h
 *
 *  Created on: Jul 25, 2015
 *      Author: pham
 */

#ifndef MATRIXCOORDINATEONORTHONORMALBASISCALCULATORIMPL_H_
#define MATRIXCOORDINATEONORTHONORMALBASISCALCULATORIMPL_H_
