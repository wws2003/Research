/*
 * DuplicateGateLookupResultFilterImpl.cpp
 *
...
template class DuplicateLookupResultFilterImpl<GatePtr>;

bool DuplicateGateLookupResultFilterImpl::sameElement(const GatePtr& pGate1, const GatePtr& pGate2) const {
