/*
 * VectorBasedGateLookupResultProcessor.cpp
 *
...
#include "VectorBasedLookupResultProcessor.cpp"

template class VectorBasedLookupResultProcessor<GatePtr>;

VectorBasedGateLookupResultProcessor::VectorBasedGateLookupResultProcessor(DistanceCalculatorPtr<GatePtr> pDistanceCalculator) : VectorBasedLookupResultProcessor<GatePtr>(pDistanceCalculator){

}

bool VectorBasedGateLookupResultProcessor::sameElement(const GatePtr& pGate1, const GatePtr& pGate2) const {
